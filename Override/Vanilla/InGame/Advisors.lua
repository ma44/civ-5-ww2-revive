...
function OnAdvisorDisplayShow (eventInfo)
	...
	if (eventInfo.Concept1 ~= nil and eventInfo.Concept1 ~= "") then
		...
		Controls.Question1String:SetText(Locale.ConvertTextKey(GameInfo.Concepts[eventInfo.Concept1].AdvisorQuestion));
	else
		Controls.Question1String:SetHide(true);
	end
	...
	if (eventInfo.Concept2 ~= nil and eventInfo.Concept2 ~= "") then
		...
		Controls.Question2String:SetText(Locale.ConvertTextKey(GameInfo.Concepts[eventInfo.Concept2].AdvisorQuestion));
	else
		Controls.Question2String:SetHide(true);
	end
	...
	if (eventInfo.Concept3 ~= nil and eventInfo.Concept3 ~= "") then
		...
		Controls.Question3String:SetText(Locale.ConvertTextKey(GameInfo.Concepts[eventInfo.Concept3].AdvisorQuestion));		
	else
		Controls.Question3String:SetHide(true);
	end
