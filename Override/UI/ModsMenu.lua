...
function Initialize()
	...
	if bNeedUpdate then
		...
		local REDversion = Modding.GetActivatedModVersion("1fa4b768-ae75-4260-b727-6a2becc6530e")
		Modding.DisableMod("1fa4b768-ae75-4260-b727-6a2becc6530e", REDversion)
		Modding.ActivateEnabledMods()
		Modding.EnableMod("1fa4b768-ae75-4260-b727-6a2becc6530e", REDversion)
		Modding.ActivateEnabledMods()
		--]]
		UIManager:SetUICursor(0)	
