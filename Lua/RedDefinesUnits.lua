...
FR_PARTISAN				= GameInfo.Units.UNIT_PARTISAN.ID
...
CA_INFANTRY				= GameInfo.Units.UNIT_CANADA_INFANTRY.ID
CC_INFANTRY				= GameInfo.Units.UNIT_COMCHIN_INFANTRY.ID
...
JP_TYPE97_SHINHOTO		= GameInfo.Units.UNIT_TANK_TYPE97_SHINHOTO.ID
...
UK_ACHILLES				= GameInfo.Units.UNIT_TANK_DESTROYER_ACHILLES.ID
...
UK_PRIEST				= GameInfo.Units.UNIT_MOBILE_ARTILLERY_PRIEST.ID
UK_SEXTON				= GameInfo.Units.UNIT_MOBILE_ARTILLERY_SEXTON.ID
...
JP_KI27					= GameInfo.Units.UNIT_FIGHTER_KI27.ID
...
JP_KI51					= GameInfo.Units.UNIT_BOMBER_KI51.ID
GR_FAIREY				= GameInfo.Units.UNIT_BOMBER_FAIREY.ID
UK_SWORDFISH			= GameInfo.Units.UNIT_BOMBER_SWORDFISH.ID
US_TBF					= GameInfo.Units.UNIT_BOMBER_TBF.ID
US_SBD					= GameInfo.Units.UNIT_BOMBER_SBD.ID
US_SB2C					= GameInfo.Units.UNIT_BOMBER_SB2C.ID
-- Fast/Light Bombers ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
GE_DESTROYER_2			= GameInfo.Units.UNIT_DESTROYER_TYPE_1936A.ID
...
US_BENSON				= GameInfo.Units.UNIT_DESTROYER_BENSON.ID
...
JP_TAKAO				= GameInfo.Units.UNIT_HEAVY_CRUISER_TAKAO.ID
						
-- Dreadnought ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
DREADNOUGHT				= GameInfo.Units.UNIT_DREADNOUGHT.ID -- NumType for unit naming...
US_PENNSYLVANIA			= GameInfo.Units.UNIT_DREADNOUGHT_PENNSYLVANIA.ID
...
UK_SUBMARINE_2			= GameInfo.Units.UNIT_SUBMARINE_UCLASS.ID
RU_SUBMARINE			= GameInfo.Units.UNIT_SUBMARINE_SHCHUKA.ID
GE_SUBMARINE			= GameInfo.Units.UNIT_SUBMARINE_U_BOAT.ID
GE_SUBMARINE_2			= GameInfo.Units.UNIT_SUBMARINE_U_BOAT2.ID
...
JP_SUBMARINE_2			= GameInfo.Units.UNIT_SUBMARINE_I400.ID
...
US_CARRIER_2			= GameInfo.Units.UNIT_CARRIER_ESSEX.ID
JP_CARRIER				= GameInfo.Units.UNIT_CARRIER_KAGA.ID
JP_CARRIER_2			= GameInfo.Units.UNIT_CARRIER_SHOKAKU.ID
FR_CARRIER				= GameInfo.Units.UNIT_CARRIER_JOFFRE.ID
GE_CARRIER				= GameInfo.Units.UNIT_CARRIER_ZEPPELIN.ID
UK_CARRIER				= GameInfo.Units.UNIT_CARRIER_ARK_ROYAL.ID
UK_CARRIER_2			= GameInfo.Units.UNIT_CARRIER_ILLUSTRIOUS.ID
IT_CARRIER				= GameInfo.Units.UNIT_CARRIER_AQUILA.ID
...
g_Major_Units = {
	[FRANCE] = {
		...
		FR_AMR35, FR_FCM36, FR_R35, FR_R40, FR_H35, FR_H39,
		FR_AMC35, FR_S35, FR_CHAR_D1, FR_CHAR_D2,
		FR_B1, FR_ARL44, FR_CHAR_2C,
		FR_SAU40,
		FR_MS406, FR_D520, FR_D790, 
		FR_MB152, FR_POTEZ630, FR_HURRICANE, FR_P40,
		FR_LN401, FR_AMIOT350, FR_BR690, FR_BR810,
		FR_FANTASQUE, FR_GALISSONIERE, FR_SUBMARINE, FR_BATTLESHIP, FR_BATTLESHIP_2, 
		ARTILLERY, AT_GUN, AA_GUN, FR_MOBILE_AA_GUN, FR_CARRIER},  ----FR_CARRIER
	[ENGLAND] = {
		UK_INFANTRY, UK_SPECIAL_FORCES, UK_PARATROOPER, UK_MECH_INFANTRY,
		UK_TETRARCH, UK_MATILDA_I, UK_CRUISER_II, UK_CRUISER_III, UK_CRUISER_IV, UK_A10_VALENTINE, UK_A15_CRUSADER, UK_A15_CRUSADER_MKIII,
		UK_MATILDA_II, UK_M4_FIREFLY, UK_VICKERS_MK6B, UK_A24, UK_A27, UK_CROMWELL, UK_A30, UK_A34, UK_M3_GRANT,
		UK_CHURCHILL, UK_A41, UK_A39,
		UK_ACHILLES, UK_ARCHER, UK_MOBILE_AA_GUN, UK_MOBILE_AA_VICKERS, UK_MOBILE_BISHOP, UK_PRIEST, UK_SEXTON,
		UK_SPITFIRE, UK_SPITFIRE_V, UK_SPITFIRE_IX, US_F4F, US_F6F, 
		UK_HURRICANE, UK_HURRICANE_II, UK_TYPHOON, UK_TEMPEST, UK_METEOR,
		UK_WHIRLWIND, UK_BEAUFIGHTER,
		UK_SWORDFISH, UK_MOSQUITO, UK_WELLINGTON, UK_HALIFAX, UK_LANCASTER, 
		UK_TRIBA, UK_SUBMARINE, UK_SUBMARINE_2, UK_LEANDER, UK_ELIZABETH, UK_BATTLESHIP, UK_BATTLESHIP_2,
		ARTILLERY, AT_GUN, UK_CARRIER, UK_CARRIER_2,}, ----UK_CARRIER, UK_CARRIER_2
	[USSR] = {
		RU_INFANTRY, RU_NAVAL_INFANTRY, RU_PARATROOPER, RU_MECH_INFANTRY, RU_SPECIAL_FORCES,
		RU_T26, RU_BT2, RU_BT7, RU_T70,
		RU_T28, RU_T34, RU_T34_76, RU_T34_85,
		RU_KV1, RU_KV2, RU_IS_1, RU_IS_2, RU_IS_3, RU_IS_7,
		RU_SU122, RU_SU152, RU_ISU122, RU_ISU152, RU_SU76, RU_SU85, RU_SU100,
		RU_SU26, RU_BM13, RU_BM13_16, RU_ZIS30, RU_ZSU37,
		RU_I16, RU_LAGG3, RU_LA5, RU_LA5_V2, RU_LA7, RU_YAK_7, RU_YAK_9,
		RU_IL2, RU_IL2M3, RU_IL10, RU_TU2, RU_IL4, RU_TB3, RU_PE8,
		RU_GNEVNY, RU_SUBMARINE, RU_KIROV, RU_GANGUT, RU_BATTLESHIP,
		RU_ARTILLERY, RU_AT_GUN, AA_GUN},
	[GERMANY] = {
		GE_INFANTRY, GE_PARATROOPER, GE_SS_INFANTRY, GE_SPECIAL_FORCES, GE_MECH_INFANTRY,
		GE_MARDER_I, GE_MARDER_II, GE_MARDER_II_D, GE_MARDER_III, GE_MARDER_III_H, GE_MARDER_III_M, GE_HETZER,  
		GE_NASHORN, GE_PZJ_IV, GE_PZJ_IV_L70, GE_JAGDPANTHER,
		GE_FERDINAND, GE_JAGDTIGER,
		...
		GE_STUG_III, GE_STUG_III_F, GE_STUG_III_G, GE_STUG_IV, GE_BRUMMBAR, GE_STURMTIGER,
		GE_MOBILE_AA_GUN, GE_MOBILE_AA_38, GE_MOBILE_AA_MOBEL, GE_MOBILE_AA_WIRBEL, GE_MOBILE_AA_OST, GE_MOBILE_AA_KUGEL, GE_MOBILE_AA_COELIAN,
		GE_MOBILE_BISON, GE_MOBILE_GRILLE, GE_MOBILE_WESPE, GE_MOBILE_HUMMEL,
		GE_BF109, GE_BF109_F, GE_BF109_G, GE_BF109_T, GE_FW190, GE_BF110, GE_BF110_F4, GE_JU88_C, GE_HE219, GE_ME262,
		GE_JU87, GE_JU87T, GE_JU88, GE_HE111, GE_HE177, GE_AR234, GE_HO229,
		GE_DESTROYER, GE_DESTROYER_2, GE_SUBMARINE, GE_SUBMARINE_2, GE_LEIPZIG, GE_DEUTSCHLAND, GE_BATTLESHIP, GE_BATTLESHIP_2, 
		ARTILLERY, AT_GUN, AA_GUN, GE_MOBILE_AA_GUN, GE_CARRIER,},  ---- GE_CARRIER
	[ITALY] = {
		IT_INFANTRY, IT_SPECIAL_FORCES, IT_PARATROOPER, 
		IT_L6_40, IT_M11_39, IT_M13_40, IT_M14_41, IT_M15_42, IT_P26_40,
		IT_SM41, IT_L40, IT_M41, IT_M42M, IT_M42T, IT_M43, IT_AUTOCANNONE,
		IT_G50, IT_G55,  IT_C200, IT_C202, IT_C205, IT_CAPRONI, GE_BF109_T,
		IT_BA65, IT_SM79, IT_SM84, GE_JU87T,
		IT_SOLDATI, IT_SUBMARINE, IT_ZARA, IT_BATTLESHIP,
		ARTILLERY, AT_GUN, AA_GUN, IT_CARRIER,},   ---- IT_CARRIER
	[AMERICA] = {
		US_INFANTRY, US_SPECIAL_FORCES, US_PARATROOPER, US_MECH_INFANTRY, US_MARINES,
		US_M3STUART, US_M5STUART, US_M24CHAFFEE,
		US_M3GRANT, US_SHERMAN, US_SHERMAN_IIA, US_SHERMAN_III, US_SHERMAN_IIIA, US_SHERMAN_IV, US_SHERMAN_JUMBO, US_SHERMAN_EASYEIGHT, US_M26_PERSHING,  US_T28_95,
		US_M7, US_M12, US_M40, US_M10, US_M18, US_M36, US_M16A1,
		US_P36, US_P40, US_P47, US_P51, US_P38, US_F2A, US_F4F, US_F6F, US_F4U, 
		US_A20, US_B17, US_B25, US_B24, US_B29, US_SBD, US_SB2C, US_TBF,
		US_SUBMARINE, US_BATTLESHIP_2, US_FLETCHER, US_BENSON, US_BALTIMORE, US_BATTLESHIP, 
		ARTILLERY, AT_GUN, AA_GUN, US_CARRIER, US_CARRIER_2,},   --US_CARRIER, US_CARRIER_2
	[JAPAN] = {
		JP_INFANTRY, JP_SPECIAL_FORCES, JP_PARATROOPER,
		JP_TYPE95, JP_TYPE4, JP_TYPE97, JP_TYPE97_SHINHOTO, JP_TYPE1, JP_TYPE3, TYPE4_CHI_TO, JP_TYPE5, JP_TYPE100,
		JP_HO_RO, JP_HA_TO, JP_TYPE2, JP_HO_NI_I, JP_HO_NI_II, JP_HO_NI_III, JP_NA_TO, JP_TYPE98,
		JP_A5M, JP_A6M2, JP_A6M5, JP_A7M, JP_KI43, JP_KI27, JP_KI44, JP_KI84, JP_KI61, JP_KI100, JP_KI100_II, JP_N1K2, JP_J2M,
		JP_AICHI, JP_KI21, JP_G4M3, JP_KI51,
		JP_SUBMARINE, JP_SUBMARINE_2, JP_BATTLESHIP_2, JP_KAGERO, JP_MYOKO, JP_TAKAO, JP_BATTLESHIP, 
		ARTILLERY, AT_GUN, AA_GUN, JP_CARRIER, JP_CARRIER_2,},  ----JP_CARRIER, JP_CARRIER_2
	[CHINA] = {
		CH_INFANTRY, CH_SPECIAL_FORCES, CH_PARATROOPER,
		CH_T26B, CH_P40N, CH_B25,
		ARTILLERY, AT_GUN, AA_GUN},
	[GREECE] = {
		GR_INFANTRY, GR_PARATROOPER, GR_SPECIAL_FORCES,
		GR_VICKERS_MKE, GR_VICKERS_MKII, GR_MOBILE_AA_VICKERS,
		GR_P24, GR_SPITFIRE,
...
g_UnitUpgrades = {
	...
	[GE_STUG_III] = GE_STUG_III_F,
	[GE_STUG_III_F] = GE_STUG_III_G,
	[GE_MARDER_I] = GE_MARDER_II,	
	[GE_MARDER_II] = GE_MARDER_II_D,
	[GE_MARDER_III] = GE_MARDER_III_H,
	[GE_MARDER_III_H] = GE_MARDER_III_M,
	[GE_PZJ_IV] = GE_PZJ_IV_L70,
	[GE_MOBILE_AA_MOBEL] = GE_MOBILE_AA_WIRBEL,
	[GE_MOBILE_AA_WIRBEL] = GE_MOBILE_AA_OST,
	[GE_MOBILE_AA_OST] = GE_MOBILE_AA_KUGEL,
	[GE_BF109] = GE_BF109_F,
	...
	[US_M5STUART] = US_M24CHAFFEE,
	[US_SHERMAN] = US_SHERMAN_IIA,
	[US_SHERMAN_IIA] = US_SHERMAN_III,
	[US_SHERMAN_III] = US_SHERMAN_IIIA,
	[US_SHERMAN_IV] = US_SHERMAN_JUMBO,
	[US_SHERMAN_JUMBO] = US_SHERMAN_EASYEIGHT,
	[US_M10] = US_M18,
	[US_M18] = US_M36,
	[US_F4F] = US_F6F,
	[JP_TYPE95] = JP_TYPE4,	
	[JP_TYPE97] = JP_TYPE97_SHINHOTO,
	[JP_TYPE1] = JP_TYPE3,	
	[JP_HO_NI_I] = JP_HO_NI_II,
	[JP_HO_NI_II] = JP_HO_NI_III,
	[JP_A6M2] = JP_A6M5,
	[JP_KI43] = JP_KI44,
	[JP_KI44] = JP_KI84,
	[JP_KI61] = JP_KI100,
	[JP_KI100] = JP_KI100_II,
}
...
g_Minor_Units = {INFANTRY, ARTILLERY, AT_GUN, AA_GUN, LIGHT_TANK, TANK, FIGHTER, DESTROYER, CRUISER, SUBMARINE}
