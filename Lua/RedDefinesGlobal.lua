...
g_RED_WWII_ModID = "1fa4b768-ae75-4260-b727-6a2becc6530e"
...
MAX_COMBAT_LOG_ENTRIES	= 150	-- Archive/delete old entries above this value
MIN_COMBAT_LOG_ENTRIES	= 50	-- Keep this number on entries in Combat Log when deleting/archiving
...
SHOW_UNIT_SUPPLY_THRESHOLD = 200		-- don't show unit supply left until this number is reached 
...
CONHUNT =		11	-- Convoy attacked
EMBHUNT =		12	-- Embarked Unit attacked
CARHUNT =		13	-- Carrier attacked
DESATTACK=		14	-- Destroyer attacking
DESHUNT =		15	-- Destroyer attacked
CRUATTACK=		16	-- Cruiser attacking
CRUHUNT =		17	-- Cruiser attacked
BATATTACK=		18	-- Battleship attacking
BATHUNT =		19	-- Battleship attacked
...
WINTERTIME = 0  --Goes to 1 if winter comes
...
COLONY =				GameInfo.Buildings.BUILDING_COLONY.ID
...
g_Buildings_Req = {
	[ACADEMY] =				{BARRACKS, FACTORY},
	[BASE] =				{BARRACKS, FACTORY},
...
WEALTH =        GameInfo.Processes.PROCESS_WEALTH.ID
...
PROMOTION_LIGHT_RATIONING_AIRCRAFT =	GameInfo.UnitPromotions.PROMOTION_LIGHT_RATIONING_AIRCRAFT.ID
PROMOTION_RATIONING_AIRCRAFT =			GameInfo.UnitPromotions.PROMOTION_RATIONING_AIRCRAFT.ID
PROMOTION_HEAVY_RATIONING_AIRCRAFT =	GameInfo.UnitPromotions.PROMOTION_HEAVY_RATIONING_AIRCRAFT.ID
...
PROMOTION_DESERT_POWER =				GameInfo.UnitPromotions.PROMOTION_DESERT_POWER.ID
...
PROMOTION_FIGHTER_2 =					GameInfo.UnitPromotions.PROMOTION_FIGHTER_2.ID
PROMOTION_FIGHTER_2_B =					GameInfo.UnitPromotions.PROMOTION_FIGHTER_2_B.ID
PROMOTION_FIGHTER_2_C =					GameInfo.UnitPromotions.PROMOTION_FIGHTER_2_C.ID
PROMOTION_FIGHTER_2_D =					GameInfo.UnitPromotions.PROMOTION_FIGHTER_2_D.ID
PROMOTION_FIGHTER_3 =					GameInfo.UnitPromotions.PROMOTION_FIGHTER_3.ID
...
PROMOTION_MOBILE_ARTILLERY =			GameInfo.UnitPromotions.PROMOTION_MOBILE_ARTILLERY.ID
PROMOTION_EARTH_LS_RANGE =				GameInfo.UnitPromotions.PROMOTION_EARTH_LS_RANGE.ID
PROMOTION_EARTH_AIR_RANGE =				GameInfo.UnitPromotions.PROMOTION_EARTH_AIR_RANGE.ID
PROMOTION_EXTRA_MOVE =					GameInfo.UnitPromotions.PROMOTION_EXTRA_MOVE.ID
----------------------------------------------------------------------------------------------------------------------------
-- R.E.D. Rules
----------------------------------------------------------------------------------------------------------------------------
