-- RedDefinesClasses
-- Author: Gedemon
-- DateCreated: 5/6/2012 8:37:37 PM
--------------------------------------------------------------
...
CLASS_LIGHT_TANK_2				= GameInfo.UnitClasses.UNITCLASS_LIGHT_TANK_2.ID
CLASS_LIGHT_TANK_2_B			= GameInfo.UnitClasses.UNITCLASS_LIGHT_TANK_2_B.ID
CLASS_LIGHT_TANK_3				= GameInfo.UnitClasses.UNITCLASS_LIGHT_TANK_3.ID
CLASS_LIGHT_TANK_DESTROYER		= GameInfo.UnitClasses.UNITCLASS_LIGHT_TANK_DESTROYER.ID
CLASS_LIGHT_TANK_DESTROYER_2	= GameInfo.UnitClasses.UNITCLASS_LIGHT_TANK_DESTROYER_2.ID
CLASS_LIGHT_TANK_DESTROYER_2_B	= GameInfo.UnitClasses.UNITCLASS_LIGHT_TANK_DESTROYER_2_B.ID
CLASS_LIGHT_TANK_DESTROYER_3	= GameInfo.UnitClasses.UNITCLASS_LIGHT_TANK_DESTROYER_3.ID
CLASS_LIGHT_TANK_DESTROYER_4	= GameInfo.UnitClasses.UNITCLASS_LIGHT_TANK_DESTROYER_4.ID
CLASS_LIGHT_TANK_DESTROYER_4_B	= GameInfo.UnitClasses.UNITCLASS_LIGHT_TANK_DESTROYER_4_B.ID
CLASS_LIGHT_TANK_DESTROYER_4_C	= GameInfo.UnitClasses.UNITCLASS_LIGHT_TANK_DESTROYER_4_C.ID
CLASS_LIGHT_TANK_DESTROYER_5	= GameInfo.UnitClasses.UNITCLASS_LIGHT_TANK_DESTROYER_5.ID
CLASS_CRUISER_TANK				= GameInfo.UnitClasses.UNITCLASS_CRUISER_TANK.ID
CLASS_CRUISER_TANK_B			= GameInfo.UnitClasses.UNITCLASS_CRUISER_TANK_B.ID
CLASS_CRUISER_TANK_2			= GameInfo.UnitClasses.UNITCLASS_CRUISER_TANK_2.ID
CLASS_CRUISER_TANK_2_B			= GameInfo.UnitClasses.UNITCLASS_CRUISER_TANK_2_B.ID
CLASS_CRUISER_TANK_3			= GameInfo.UnitClasses.UNITCLASS_CRUISER_TANK_3.ID
CLASS_CRUISER_TANK_4			= GameInfo.UnitClasses.UNITCLASS_CRUISER_TANK_4.ID
CLASS_CRUISER_TANK_4_B			= GameInfo.UnitClasses.UNITCLASS_CRUISER_TANK_4_B.ID
CLASS_CRUISER_TANK_5			= GameInfo.UnitClasses.UNITCLASS_CRUISER_TANK_5.ID
CLASS_CRUISER_TANK_5_B			= GameInfo.UnitClasses.UNITCLASS_CRUISER_TANK_5_B.ID
...
CLASS_TANK_2_D					= GameInfo.UnitClasses.UNITCLASS_TANK_2_D.ID
CLASS_TANK_3					= GameInfo.UnitClasses.UNITCLASS_TANK_3.ID
CLASS_MAIN_BATTLE_TANK			= GameInfo.UnitClasses.UNITCLASS_MAIN_BATTLE_TANK.ID
CLASS_HEAVY_TANK				= GameInfo.UnitClasses.UNITCLASS_HEAVY_TANK.ID
CLASS_HEAVY_TANK_B				= GameInfo.UnitClasses.UNITCLASS_HEAVY_TANK_B.ID
CLASS_HEAVY_TANK_2				= GameInfo.UnitClasses.UNITCLASS_HEAVY_TANK_2.ID
CLASS_HEAVY_TANK_2_B			= GameInfo.UnitClasses.UNITCLASS_HEAVY_TANK_2_B.ID
CLASS_HEAVY_TANK_2_C			= GameInfo.UnitClasses.UNITCLASS_HEAVY_TANK_2_C.ID
CLASS_HEAVY_TANK_3				= GameInfo.UnitClasses.UNITCLASS_HEAVY_TANK_3.ID
CLASS_SUPER_HEAVY_TANK			= GameInfo.UnitClasses.UNITCLASS_SUPER_HEAVY_TANK.ID
CLASS_TANK_DESTROYER			= GameInfo.UnitClasses.UNITCLASS_TANK_DESTROYER.ID
CLASS_TANK_DESTROYER_B			= GameInfo.UnitClasses.UNITCLASS_TANK_DESTROYER_B.ID
CLASS_TANK_DESTROYER_2			= GameInfo.UnitClasses.UNITCLASS_TANK_DESTROYER_2.ID
CLASS_TANK_DESTROYER_2_B		= GameInfo.UnitClasses.UNITCLASS_TANK_DESTROYER_2_B.ID
CLASS_TANK_DESTROYER_3			= GameInfo.UnitClasses.UNITCLASS_TANK_DESTROYER_3.ID
CLASS_HEAVY_TANK_DESTROYER		= GameInfo.UnitClasses.UNITCLASS_HEAVY_TANK_DESTROYER.ID
CLASS_HEAVY_TANK_DESTROYER_2	= GameInfo.UnitClasses.UNITCLASS_HEAVY_TANK_DESTROYER_2.ID
CLASS_ASSAULT_GUN				= GameInfo.UnitClasses.UNITCLASS_ASSAULT_GUN.ID
CLASS_ASSAULT_GUN_B				= GameInfo.UnitClasses.UNITCLASS_ASSAULT_GUN_B.ID
...
CLASS_FIGHTER_C				= GameInfo.UnitClasses.UNITCLASS_FIGHTER_C.ID
...
CLASS_HEAVY_BOMBER_2	= GameInfo.UnitClasses.UNITCLASS_HEAVY_BOMBER_2.ID
CLASS_HEAVY_BOMBER_3	= GameInfo.UnitClasses.UNITCLASS_HEAVY_BOMBER_3.ID
--
CLASS_CONVOY = GameInfo.UnitClasses.UNITCLASS_CONVOY.ID
--
CLASS_DESTROYER		= GameInfo.UnitClasses.UNITCLASS_DESTROYER.ID
CLASS_DESTROYER_2	= GameInfo.UnitClasses.UNITCLASS_DESTROYER_2.ID
CLASS_BATTLESHIP	= GameInfo.UnitClasses.UNITCLASS_BATTLESHIP.ID
CLASS_BATTLESHIP_2	= GameInfo.UnitClasses.UNITCLASS_BATTLESHIP_2.ID
CLASS_CRUISER		= GameInfo.UnitClasses.UNITCLASS_CRUISER.ID
CLASS_HEAVY_CRUISER = GameInfo.UnitClasses.UNITCLASS_HEAVY_CRUISER.ID
CLASS_DREADNOUGHT	= GameInfo.UnitClasses.UNITCLASS_DREADNOUGHT.ID
CLASS_SUBMARINE		= GameInfo.UnitClasses.UNITCLASS_SUBMARINE.ID
CLASS_SUBMARINE_2	= GameInfo.UnitClasses.UNITCLASS_SUBMARINE_2.ID
CLASS_SUBMARINE_3	= GameInfo.UnitClasses.UNITCLASS_SUBMARINE_3.ID
CLASS_CARRIER		= GameInfo.UnitClasses.UNITCLASS_CARRIER.ID
CLASS_CARRIER_2		= GameInfo.UnitClasses.UNITCLASS_CARRIER_2.ID
...
g_Unit_Classes = { 
	...
	[CLASS_WORKER] =					{Regiment = false,	Capture = false, Moral = 100, NumType = CLASS_WORKER, 				MaxHP = 100, 	Buildings = {BARRACKS},},
	...
	[CLASS_INFANTRY_3] =				{Regiment = false,	Capture = true, Moral = 100, NumType = CLASS_INFANTRY_3, 			MaxHP = 100, 	Buildings = {BARRACKS},},
	...
	[CLASS_AA_GUN] =					{Regiment = true,	Capture = false, Moral = 100, NumType = CLASS_AA_GUN,				MaxHP = 100, 	Buildings = {FACTORY},},
	...
	[CLASS_MOBILE_AA_GUN] =				{Regiment = true,	Capture = false, Moral = 100, NumType = CLASS_AA_GUN,				MaxHP = 100, 	Buildings = {LAND_FACTORY},},
	[CLASS_MOBILE_AA_GUN_B] =			{Regiment = true,	Capture = false, Moral = 100, NumType = CLASS_AA_GUN,				MaxHP = 100, 	Buildings = {LAND_FACTORY},},
	[CLASS_MOBILE_AA_GUN_2] =			{Regiment = true,	Capture = false, Moral = 100, NumType = CLASS_AA_GUN,				MaxHP = 100, 	Buildings = {LAND_FACTORY},},
	[CLASS_MOBILE_AA_GUN_2_B] =			{Regiment = true,	Capture = false, Moral = 100, NumType = CLASS_AA_GUN,				MaxHP = 100, 	Buildings = {LAND_FACTORY},},
	[CLASS_MOBILE_AA_GUN_2_C] =			{Regiment = true,	Capture = false, Moral = 100, NumType = CLASS_AA_GUN,				MaxHP = 100, 	Buildings = {LAND_FACTORY},},
	[CLASS_MOBILE_AA_GUN_2_D] =			{Regiment = true,	Capture = false, Moral = 100, NumType = CLASS_AA_GUN,				MaxHP = 100, 	Buildings = {LAND_FACTORY},},
	[CLASS_MOBILE_AA_GUN_3] =			{Regiment = true,	Capture = false, Moral = 100, NumType = CLASS_AA_GUN,				MaxHP = 100, 	Buildings = {LAND_FACTORY},},
	--
