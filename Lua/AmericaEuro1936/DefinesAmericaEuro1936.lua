...
g_Initial_OOB = {
	...
	{Name = "German central army", X = 84, Y = 47, Domain = "Land", CivID = GERMANY, Group = {GE_INFANTRY, GE_INFANTRY, GE_PANZER_I, GE_PANZER_II, GE_PANZER_III, AT_GUN}, UnitsXP = {60,60,60,60,60,60},  },
	{Name = "German north army", X = 86, Y = 52, Domain = "Land", CivID = GERMANY, Group = {GE_MARDER_I, GE_INFANTRY, GE_PANZER_I, GE_PANZER_II, GE_PANZER_III, AT_GUN}, UnitsXP = {60,60,60,60,60,60},  },
	{Name = "German east army", X = 603, Y = 46, Domain = "City", AI = true, CivID = GERMANY, Group = {GE_INFANTRY, GE_INFANTRY, GE_PANZER_I, GE_PANZER_II, GE_PANZER_III, AT_GUN}, UnitsXP = {60,60,60,60,60,60},  },
	{Name = "German Berlin army", X = 860, Y = 50, Domain = "City", AI = true, CivID = GERMANY, Group = {GE_INFANTRY, GE_INFANTRY, GE_PANZER_II, GE_PANZER_III, GE_PANZER_I, AT_GUN}, UnitsXP = {60,60,60,60,60,60},  },
	{Name = "German Luftwaffe", X = 860, Y = 50, Domain = "Air", CivID = GERMANY, Group = {GE_BF1060, GE_BF1060, GE_HE111, GE_HE111, GE_JU87, GE_JU87, GE_JU87}, UnitsXP = {60,60,60,60,60,60,60},  }, 
	{Name = "German Luftwaffe AI Bonus", X = 603, Y = 46, Domain = "Air", AI = true, CivID = GERMANY, Group = {GE_BF1060, GE_BF1060, GE_HE111, GE_JU87}, UnitsXP = {60,60,60,60}, },
	{Name = "German Fleet", X = 602, Y = 55, Domain = "Sea", CivID = GERMANY, Group = {GE_BATTLESHIP_2, GE_DESTROYER, GE_BATTLESHIP, GE_DESTROYER}, UnitsXP = {60,60,60,60},  },
	{Name = "German Submarine Fleet", X = 860, Y = 55, Domain = "Sea", CivID = GERMANY, Group = { GE_SUBMARINE, GE_SUBMARINE, GE_SUBMARINE, GE_DESTROYER, GE_DEUTSCHLAND}, UnitsXP = {60,60,60,60,60},  },
	{Name = "German Submarine AI Bonus", X = 40, Y = 53, Domain = "Sea", AI = true, CivID = GERMANY, Group = { GE_SUBMARINE, GE_SUBMARINE, GE_SUBMARINE, GE_SUBMARINE, GE_SUBMARINE}, UnitsXP = {60,60,60,60,60}, },
	{Name = "German Fleet AI bonus", X = 87, Y = 62, Domain = "Sea", AI = true, CivID = GERMANY, Group = { GE_LEIPZIG, GE_DESTROYER, GE_DESTROYER, GE_DESTROYER}, UnitsXP = {60,60,60,60},  },
