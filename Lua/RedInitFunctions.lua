...
function CommonOnActivePlayerTurn()
	Dprint("Starting CommonOnActivePlayerTurn ...")
	ShowResourceData()
...
function CommonOnFirstTurn()
	 Dprint("Starting CommonOnFirstTurn ...")
end
...
function CommonOnGameInitReloaded()
	 Dprint("Starting CommonOnGameInitReloaded ...")
	-- calling order is important ! 
	InitializeGameOption()								-- before everything else !
	LoadAllTable()										-- before any change on tables...
	OnLoadMapUpdate()
...
function CommonOnEnterGame()
	Dprint("Starting CommonOnEnterGame ...")
	--ShowUnitData()
	...
	GameEvents.PlayerDoTurn.Add( UpdatePlayerDatas )
	...
	--GameEvents.CityCanMaintain.Add( SetMaintainCityBuilds )
