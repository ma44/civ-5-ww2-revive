...
UPDATE Defines SET Value =42 WHERE Name = 'EXPERIENCE_DEFENDING_UNIT_MELEE'; -- default = 4
...
--------------------------------------------------------------------------------------------
--/*
UPDATE Leaders SET Boldness = 10,	VictoryCompetitiveness = 10,		Meanness = 10	WHERE Type = 'LEADER_AUGUSTUS';		-- ITALY
UPDATE Leaders SET Boldness = 10,	VictoryCompetitiveness = 10,		Meanness = 10	WHERE Type = 'LEADER_BISMARCK';		-- GERMANY
UPDATE Leaders SET Boldness = 10,	VictoryCompetitiveness = 10,		Meanness = 10	WHERE Type = 'LEADER_CATHERINE';	-- U.S.S.R.
UPDATE Leaders SET Boldness = 10,	VictoryCompetitiveness = 10,		Meanness = 10	WHERE Type = 'LEADER_ODA_NOBUNAGA';	-- Japan
UPDATE Leaders SET Boldness = 10,	VictoryCompetitiveness = 10,		Meanness = 10	WHERE Type = 'LEADER_NAPOLEON';		-- France
UPDATE Leaders SET Boldness = 10,	VictoryCompetitiveness = 10,		Meanness = 10	WHERE Type = 'LEADER_ELIZABETH';	-- U.K.
UPDATE Leaders SET Boldness = 10,	VictoryCompetitiveness = 10,		Meanness = 10	WHERE Type = 'LEADER_WUZETIAN';		-- China
UPDATE Leaders SET Boldness = 10,	VictoryCompetitiveness = 10,		Meanness = 10	WHERE Type = 'LEADER_WASHINGTON';	-- U.S.A.
UPDATE Leaders SET Boldness = 10,	VictoryCompetitiveness = 10,		Meanness = 10	WHERE Type = 'LEADER_ALEXANDER';	-- Greece

UPDATE Leader_Flavors SET Flavor = 18	WHERE FlavorType = 'FLAVOR_OFFENSE'	AND LeaderType = 'LEADER_AUGUSTUS';		-- ITALY
UPDATE Leader_Flavors SET Flavor = 18	WHERE FlavorType = 'FLAVOR_OFFENSE'	AND LeaderType = 'LEADER_BISMARCK';		-- GERMANY
UPDATE Leader_Flavors SET Flavor = 18	WHERE FlavorType = 'FLAVOR_OFFENSE'	AND LeaderType = 'LEADER_CATHERINE';	-- U.S.S.R.
UPDATE Leader_Flavors SET Flavor = 18	WHERE FlavorType = 'FLAVOR_OFFENSE'	AND LeaderType = 'LEADER_ODA_NOBUNAGA';	-- Japan
UPDATE Leader_Flavors SET Flavor = 14	WHERE FlavorType = 'FLAVOR_OFFENSE'	AND LeaderType = 'LEADER_NAPOLEON';		-- France
UPDATE Leader_Flavors SET Flavor = 14	WHERE FlavorType = 'FLAVOR_OFFENSE'	AND LeaderType = 'LEADER_ELIZABETH';	-- U.K.
UPDATE Leader_Flavors SET Flavor = 12	WHERE FlavorType = 'FLAVOR_OFFENSE'	AND LeaderType = 'LEADER_WUZETIAN';		-- China
UPDATE Leader_Flavors SET Flavor = 18	WHERE FlavorType = 'FLAVOR_OFFENSE'	AND LeaderType = 'LEADER_WASHINGTON';	-- U.S.A.
UPDATE Leader_Flavors SET Flavor = 12	WHERE FlavorType = 'FLAVOR_OFFENSE'	AND LeaderType = 'LEADER_ALEXANDER';	-- Greece

UPDATE Leader_Flavors SET Flavor = 12	WHERE FlavorType = 'FLAVOR_DEFENSE'	AND LeaderType = 'LEADER_AUGUSTUS';		-- ITALY
UPDATE Leader_Flavors SET Flavor = 12	WHERE FlavorType = 'FLAVOR_DEFENSE'	AND LeaderType = 'LEADER_BISMARCK';		-- GERMANY
UPDATE Leader_Flavors SET Flavor = 16	WHERE FlavorType = 'FLAVOR_DEFENSE'	AND LeaderType = 'LEADER_CATHERINE';	-- U.S.S.R.
UPDATE Leader_Flavors SET Flavor = 14	WHERE FlavorType = 'FLAVOR_DEFENSE'	AND LeaderType = 'LEADER_ODA_NOBUNAGA';	-- Japan
UPDATE Leader_Flavors SET Flavor = 16	WHERE FlavorType = 'FLAVOR_DEFENSE'	AND LeaderType = 'LEADER_NAPOLEON';		-- France
UPDATE Leader_Flavors SET Flavor = 16	WHERE FlavorType = 'FLAVOR_DEFENSE'	AND LeaderType = 'LEADER_ELIZABETH';	-- U.K.
UPDATE Leader_Flavors SET Flavor = 18	WHERE FlavorType = 'FLAVOR_DEFENSE'	AND LeaderType = 'LEADER_WUZETIAN';		-- China
UPDATE Leader_Flavors SET Flavor = 16	WHERE FlavorType = 'FLAVOR_DEFENSE'	AND LeaderType = 'LEADER_WASHINGTON';	-- U.S.A.
UPDATE Leader_Flavors SET Flavor = 18	WHERE FlavorType = 'FLAVOR_DEFENSE'	AND LeaderType = 'LEADER_ALEXANDER';	-- Greece

UPDATE Leader_Flavors SET Flavor = 12	WHERE FlavorType = 'FLAVOR_CITY_DEFENSE'	AND LeaderType = 'LEADER_AUGUSTUS';		-- ITALY
UPDATE Leader_Flavors SET Flavor = 12	WHERE FlavorType = 'FLAVOR_CITY_DEFENSE'	AND LeaderType = 'LEADER_BISMARCK';		-- GERMANY
UPDATE Leader_Flavors SET Flavor = 16	WHERE FlavorType = 'FLAVOR_CITY_DEFENSE'	AND LeaderType = 'LEADER_CATHERINE';	-- U.S.S.R.
UPDATE Leader_Flavors SET Flavor = 14	WHERE FlavorType = 'FLAVOR_CITY_DEFENSE'	AND LeaderType = 'LEADER_ODA_NOBUNAGA';	-- Japan
UPDATE Leader_Flavors SET Flavor = 16	WHERE FlavorType = 'FLAVOR_CITY_DEFENSE'	AND LeaderType = 'LEADER_NAPOLEON';		-- France
UPDATE Leader_Flavors SET Flavor = 16	WHERE FlavorType = 'FLAVOR_CITY_DEFENSE'	AND LeaderType = 'LEADER_ELIZABETH';	-- U.K.
UPDATE Leader_Flavors SET Flavor = 18	WHERE FlavorType = 'FLAVOR_CITY_DEFENSE'	AND LeaderType = 'LEADER_WUZETIAN';		-- China
UPDATE Leader_Flavors SET Flavor = 16	WHERE FlavorType = 'FLAVOR_CITY_DEFENSE'	AND LeaderType = 'LEADER_WASHINGTON';	-- U.S.A.
UPDATE Leader_Flavors SET Flavor = 18	WHERE FlavorType = 'FLAVOR_CITY_DEFENSE'	AND LeaderType = 'LEADER_ALEXANDER';	-- Greece

UPDATE Leader_Flavors SET Flavor = 10	WHERE FlavorType = 'FLAVOR_MILITARY_TRAINING'	AND LeaderType = 'LEADER_AUGUSTUS';		-- ITALY
UPDATE Leader_Flavors SET Flavor = 12	WHERE FlavorType = 'FLAVOR_MILITARY_TRAINING'	AND LeaderType = 'LEADER_BISMARCK';		-- GERMANY
UPDATE Leader_Flavors SET Flavor = 10	WHERE FlavorType = 'FLAVOR_MILITARY_TRAINING'	AND LeaderType = 'LEADER_CATHERINE';	-- U.S.S.R.
UPDATE Leader_Flavors SET Flavor = 12	WHERE FlavorType = 'FLAVOR_MILITARY_TRAINING'	AND LeaderType = 'LEADER_ODA_NOBUNAGA';	-- Japan
UPDATE Leader_Flavors SET Flavor = 10	WHERE FlavorType = 'FLAVOR_MILITARY_TRAINING'	AND LeaderType = 'LEADER_NAPOLEON';		-- France
UPDATE Leader_Flavors SET Flavor = 10	WHERE FlavorType = 'FLAVOR_MILITARY_TRAINING'	AND LeaderType = 'LEADER_ELIZABETH';	-- U.K.
UPDATE Leader_Flavors SET Flavor = 10	WHERE FlavorType = 'FLAVOR_MILITARY_TRAINING'	AND LeaderType = 'LEADER_WUZETIAN';		-- China
UPDATE Leader_Flavors SET Flavor = 12	WHERE FlavorType = 'FLAVOR_MILITARY_TRAINING'	AND LeaderType = 'LEADER_WASHINGTON';	-- U.S.A.
UPDATE Leader_Flavors SET Flavor = 10	WHERE FlavorType = 'FLAVOR_MILITARY_TRAINING'	AND LeaderType = 'LEADER_ALEXANDER';	-- Greece

UPDATE Leader_Flavors SET Flavor = 10	WHERE FlavorType = 'FLAVOR_RECON'	AND LeaderType = 'LEADER_AUGUSTUS';		-- ITALY
UPDATE Leader_Flavors SET Flavor = 10	WHERE FlavorType = 'FLAVOR_RECON'	AND LeaderType = 'LEADER_BISMARCK';		-- GERMANY
UPDATE Leader_Flavors SET Flavor = 10	WHERE FlavorType = 'FLAVOR_RECON'	AND LeaderType = 'LEADER_CATHERINE';	-- U.S.S.R.
UPDATE Leader_Flavors SET Flavor = 10	WHERE FlavorType = 'FLAVOR_RECON'	AND LeaderType = 'LEADER_ODA_NOBUNAGA';	-- Japan
UPDATE Leader_Flavors SET Flavor = 10	WHERE FlavorType = 'FLAVOR_RECON'	AND LeaderType = 'LEADER_NAPOLEON';		-- France
UPDATE Leader_Flavors SET Flavor = 10	WHERE FlavorType = 'FLAVOR_RECON'	AND LeaderType = 'LEADER_ELIZABETH';	-- U.K.
UPDATE Leader_Flavors SET Flavor = 10	WHERE FlavorType = 'FLAVOR_RECON'	AND LeaderType = 'LEADER_WUZETIAN';		-- China
UPDATE Leader_Flavors SET Flavor = 10	WHERE FlavorType = 'FLAVOR_RECON'	AND LeaderType = 'LEADER_WASHINGTON';	-- U.S.A.
UPDATE Leader_Flavors SET Flavor = 10	WHERE FlavorType = 'FLAVOR_RECON'	AND LeaderType = 'LEADER_ALEXANDER';	-- Greece

UPDATE Leader_Flavors SET Flavor = 10	WHERE FlavorType = 'FLAVOR_RANGED'	AND LeaderType = 'LEADER_AUGUSTUS';		-- ITALY
UPDATE Leader_Flavors SET Flavor = 10	WHERE FlavorType = 'FLAVOR_RANGED'	AND LeaderType = 'LEADER_BISMARCK';		-- GERMANY
UPDATE Leader_Flavors SET Flavor = 10	WHERE FlavorType = 'FLAVOR_RANGED'	AND LeaderType = 'LEADER_CATHERINE';	-- U.S.S.R.
UPDATE Leader_Flavors SET Flavor = 10	WHERE FlavorType = 'FLAVOR_RANGED'	AND LeaderType = 'LEADER_ODA_NOBUNAGA';	-- Japan
UPDATE Leader_Flavors SET Flavor = 10	WHERE FlavorType = 'FLAVOR_RANGED'	AND LeaderType = 'LEADER_NAPOLEON';		-- France
UPDATE Leader_Flavors SET Flavor = 10	WHERE FlavorType = 'FLAVOR_RANGED'	AND LeaderType = 'LEADER_ELIZABETH';	-- U.K.
UPDATE Leader_Flavors SET Flavor = 10	WHERE FlavorType = 'FLAVOR_RANGED'	AND LeaderType = 'LEADER_WUZETIAN';		-- China
UPDATE Leader_Flavors SET Flavor = 10	WHERE FlavorType = 'FLAVOR_RANGED'	AND LeaderType = 'LEADER_WASHINGTON';	-- U.S.A.
UPDATE Leader_Flavors SET Flavor = 10	WHERE FlavorType = 'FLAVOR_RANGED'	AND LeaderType = 'LEADER_ALEXANDER';	-- Greece

UPDATE Leader_Flavors SET Flavor = 10	WHERE FlavorType = 'FLAVOR_MOBILE'	AND LeaderType = 'LEADER_AUGUSTUS';		-- ITALY
UPDATE Leader_Flavors SET Flavor = 10	WHERE FlavorType = 'FLAVOR_MOBILE'	AND LeaderType = 'LEADER_BISMARCK';		-- GERMANY
UPDATE Leader_Flavors SET Flavor = 10	WHERE FlavorType = 'FLAVOR_MOBILE'	AND LeaderType = 'LEADER_CATHERINE';	-- U.S.S.R.
UPDATE Leader_Flavors SET Flavor = 10	WHERE FlavorType = 'FLAVOR_MOBILE'	AND LeaderType = 'LEADER_ODA_NOBUNAGA';	-- Japan
UPDATE Leader_Flavors SET Flavor = 10	WHERE FlavorType = 'FLAVOR_MOBILE'	AND LeaderType = 'LEADER_NAPOLEON';		-- France
UPDATE Leader_Flavors SET Flavor = 10	WHERE FlavorType = 'FLAVOR_MOBILE'	AND LeaderType = 'LEADER_ELIZABETH';	-- U.K.
UPDATE Leader_Flavors SET Flavor = 10	WHERE FlavorType = 'FLAVOR_MOBILE'	AND LeaderType = 'LEADER_WUZETIAN';		-- China
UPDATE Leader_Flavors SET Flavor = 10	WHERE FlavorType = 'FLAVOR_MOBILE'	AND LeaderType = 'LEADER_WASHINGTON';	-- U.S.A.
UPDATE Leader_Flavors SET Flavor = 10	WHERE FlavorType = 'FLAVOR_MOBILE'	AND LeaderType = 'LEADER_ALEXANDER';	-- Greece

UPDATE Leader_Flavors SET Flavor = 14	WHERE FlavorType = 'FLAVOR_NAVAL'	AND LeaderType = 'LEADER_AUGUSTUS';		-- ITALY
UPDATE Leader_Flavors SET Flavor = 10	WHERE FlavorType = 'FLAVOR_NAVAL'	AND LeaderType = 'LEADER_BISMARCK';		-- GERMANY
UPDATE Leader_Flavors SET Flavor = 10	WHERE FlavorType = 'FLAVOR_NAVAL'	AND LeaderType = 'LEADER_CATHERINE';	-- U.S.S.R.
UPDATE Leader_Flavors SET Flavor = 14	WHERE FlavorType = 'FLAVOR_NAVAL'	AND LeaderType = 'LEADER_ODA_NOBUNAGA';	-- Japan
UPDATE Leader_Flavors SET Flavor = 12	WHERE FlavorType = 'FLAVOR_NAVAL'	AND LeaderType = 'LEADER_NAPOLEON';		-- France
UPDATE Leader_Flavors SET Flavor = 16	WHERE FlavorType = 'FLAVOR_NAVAL'	AND LeaderType = 'LEADER_ELIZABETH';	-- U.K.
UPDATE Leader_Flavors SET Flavor = 10	WHERE FlavorType = 'FLAVOR_NAVAL'	AND LeaderType = 'LEADER_WUZETIAN';		-- China
UPDATE Leader_Flavors SET Flavor = 16	WHERE FlavorType = 'FLAVOR_NAVAL'	AND LeaderType = 'LEADER_WASHINGTON';	-- U.S.A.
UPDATE Leader_Flavors SET Flavor = 10	WHERE FlavorType = 'FLAVOR_NAVAL'	AND LeaderType = 'LEADER_ALEXANDER';	-- Greece

UPDATE Leader_Flavors SET Flavor = 8	WHERE FlavorType = 'FLAVOR_NAVAL_RECON'	AND LeaderType = 'LEADER_AUGUSTUS';		-- ITALY
UPDATE Leader_Flavors SET Flavor = 6	WHERE FlavorType = 'FLAVOR_NAVAL_RECON'	AND LeaderType = 'LEADER_BISMARCK';		-- GERMANY
UPDATE Leader_Flavors SET Flavor = 6	WHERE FlavorType = 'FLAVOR_NAVAL_RECON'	AND LeaderType = 'LEADER_CATHERINE';	-- U.S.S.R.
UPDATE Leader_Flavors SET Flavor = 8	WHERE FlavorType = 'FLAVOR_NAVAL_RECON'	AND LeaderType = 'LEADER_ODA_NOBUNAGA';	-- Japan
UPDATE Leader_Flavors SET Flavor = 8	WHERE FlavorType = 'FLAVOR_NAVAL_RECON'	AND LeaderType = 'LEADER_NAPOLEON';		-- France
UPDATE Leader_Flavors SET Flavor = 8	WHERE FlavorType = 'FLAVOR_NAVAL_RECON'	AND LeaderType = 'LEADER_ELIZABETH';	-- U.K.
UPDATE Leader_Flavors SET Flavor = 6	WHERE FlavorType = 'FLAVOR_NAVAL_RECON'	AND LeaderType = 'LEADER_WUZETIAN';		-- China
UPDATE Leader_Flavors SET Flavor = 8	WHERE FlavorType = 'FLAVOR_NAVAL_RECON'	AND LeaderType = 'LEADER_WASHINGTON';	-- U.S.A.
UPDATE Leader_Flavors SET Flavor = 6	WHERE FlavorType = 'FLAVOR_NAVAL_RECON'	AND LeaderType = 'LEADER_ALEXANDER';	-- Greece

UPDATE Leader_Flavors SET Flavor = 12	WHERE FlavorType = 'FLAVOR_AIR'	AND LeaderType = 'LEADER_AUGUSTUS';		-- ITALY
UPDATE Leader_Flavors SET Flavor = 14	WHERE FlavorType = 'FLAVOR_AIR'	AND LeaderType = 'LEADER_BISMARCK';		-- GERMANY
UPDATE Leader_Flavors SET Flavor = 12	WHERE FlavorType = 'FLAVOR_AIR'	AND LeaderType = 'LEADER_CATHERINE';	-- U.S.S.R.
UPDATE Leader_Flavors SET Flavor = 14	WHERE FlavorType = 'FLAVOR_AIR'	AND LeaderType = 'LEADER_ODA_NOBUNAGA';	-- Japan
UPDATE Leader_Flavors SET Flavor = 14	WHERE FlavorType = 'FLAVOR_AIR'	AND LeaderType = 'LEADER_NAPOLEON';		-- France
UPDATE Leader_Flavors SET Flavor = 14	WHERE FlavorType = 'FLAVOR_AIR'	AND LeaderType = 'LEADER_ELIZABETH';	-- U.K.
UPDATE Leader_Flavors SET Flavor = 10	WHERE FlavorType = 'FLAVOR_AIR'	AND LeaderType = 'LEADER_WUZETIAN';		-- China
UPDATE Leader_Flavors SET Flavor = 14	WHERE FlavorType = 'FLAVOR_AIR'	AND LeaderType = 'LEADER_WASHINGTON';	-- U.S.A.
UPDATE Leader_Flavors SET Flavor = 10	WHERE FlavorType = 'FLAVOR_AIR'	AND LeaderType = 'LEADER_ALEXANDER';	-- Greece
...
UPDATE Leader_Flavors SET Flavor = 16	WHERE FlavorType = 'FLAVOR_EXPANSION'	AND LeaderType = 'LEADER_CATHERINE';	-- U.S.S.R.
UPDATE Leader_Flavors SET Flavor = 18	WHERE FlavorType = 'FLAVOR_EXPANSION'	AND LeaderType = 'LEADER_ODA_NOBUNAGA';	-- Japan
UPDATE Leader_Flavors SET Flavor = 14	WHERE FlavorType = 'FLAVOR_EXPANSION'	AND LeaderType = 'LEADER_NAPOLEON';		-- France
UPDATE Leader_Flavors SET Flavor = 14	WHERE FlavorType = 'FLAVOR_EXPANSION'	AND LeaderType = 'LEADER_ELIZABETH';	-- U.K.
UPDATE Leader_Flavors SET Flavor = 14	WHERE FlavorType = 'FLAVOR_EXPANSION'	AND LeaderType = 'LEADER_WUZETIAN';		-- China
UPDATE Leader_Flavors SET Flavor = 14	WHERE FlavorType = 'FLAVOR_EXPANSION'	AND LeaderType = 'LEADER_WASHINGTON';	-- U.S.A.
UPDATE Leader_Flavors SET Flavor = 10	WHERE FlavorType = 'FLAVOR_EXPANSION'	AND LeaderType = 'LEADER_ALEXANDER';	-- Greece
