...
----------------------------------------------------------------
--[[
function OnHotSeatLoadClick()
	UIManager:QueuePopup( Controls.HotSeatLoad, PopupPriority.HotSeatLoad );
end
Controls.LoadHotseatGameButton:RegisterCallback(Mouse.eLClick, OnHotSeatLoadClick);
----------------------------------------------------------------
function OnSingleLoadClick()
	UIManager:QueuePopup( Controls.SingleLoad, PopupPriority.SingleLoad );
end
Controls.LoadSingleGameButton:RegisterCallback(Mouse.eLClick, OnSingleLoadClick);
----------------------------------------------------------------    --]]
