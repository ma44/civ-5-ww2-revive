--------------------------------------------------------------
--------------------------------------------------------------
-- R.E.D. Pacific1942 Setup
-- Author: Firaxis, Gedemon, bacononaboat
--------------------------------------------------------------
--------------------------------------------------------------
...
scenarioMap = Modding.GetEvaluatedFilePath(myModId, myModVersion, "Pacific1942.Civ5Map");
...
--		Controls.StartButton:SetText("[COLOR_WARNING_TEXT]DATAFILES NOT LOADED[ENDCOLOR]")
	...
	--else
		modUserData.SetValue("RedLoading", "Pacific1942")
...
function Initialize()
	...
	Controls.RedWW2Logo:SetTextureAndResize( "IwoJimaBackground.dds" )
...
function SetPlayerIndex(playerIndex)
	...
	if(playerIndex ~= nil) then		
		...
		-- Sets Dawn of Man Quote
		Controls.Quote:LocalizeAndSetText("TXT_KEY_RED_PACIFIC_BRIEFING");		
    end
